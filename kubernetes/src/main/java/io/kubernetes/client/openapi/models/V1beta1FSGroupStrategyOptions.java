...
public class V1beta1FSGroupStrategyOptions {
  ...
  * @throws IOException if the JSON Object is invalid with respect to V1beta1FSGroupStrategyOptions
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!V1beta1FSGroupStrategyOptions.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in V1beta1FSGroupStrategyOptions is not found in the empty JSON string", V1beta1FSGroupStrategyOptions.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!V1beta1FSGroupStrategyOptions.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `V1beta1FSGroupStrategyOptions` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!V1beta1FSGroupStrategyOptions.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'V1beta1FSGroupStrategyOptions' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<V1beta1FSGroupStrategyOptions> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(V1beta1FSGroupStrategyOptions.class));

       return (TypeAdapter<T>) new TypeAdapter<V1beta1FSGroupStrategyOptions>() {
           @Override
           public void write(JsonWriter out, V1beta1FSGroupStrategyOptions value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public V1beta1FSGroupStrategyOptions read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of V1beta1FSGroupStrategyOptions given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of V1beta1FSGroupStrategyOptions
  * @throws IOException if the JSON string is invalid with respect to V1beta1FSGroupStrategyOptions
  */
  public static V1beta1FSGroupStrategyOptions fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, V1beta1FSGroupStrategyOptions.class);
  }

 /**
  * Convert an instance of V1beta1FSGroupStrategyOptions to an JSON string
  *
  * @return JSON string
  */
