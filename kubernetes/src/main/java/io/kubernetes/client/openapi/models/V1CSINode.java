  ...
  */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!V1CSINode.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'V1CSINode' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<V1CSINode> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(V1CSINode.class));

       return (TypeAdapter<T>) new TypeAdapter<V1CSINode>() {
           @Override
           public void write(JsonWriter out, V1CSINode value) throws IOException {
