...
public class V1CSIDriverList implements io.kubernetes.client.common.KubernetesListObject {
  ...
  */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!V1CSIDriverList.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'V1CSIDriverList' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<V1CSIDriverList> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(V1CSIDriverList.class));

       return (TypeAdapter<T>) new TypeAdapter<V1CSIDriverList>() {
           @Override
           public void write(JsonWriter out, V1CSIDriverList value) throws IOException {
 ...
 /**
  * Create an instance of V1CSIDriverList given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of V1CSIDriverList
  * @throws IOException if the JSON string is invalid with respect to V1CSIDriverList
  */
  public static V1CSIDriverList fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, V1CSIDriverList.class);
  }

 /**
  * Convert an instance of V1CSIDriverList to an JSON string
  *
  * @return JSON string
  */
