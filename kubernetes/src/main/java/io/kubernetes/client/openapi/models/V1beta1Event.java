...
public class V1beta1Event implements io.kubernetes.client.common.KubernetesObject {
  ...
  * @throws IOException if the JSON Object is invalid with respect to V1beta1Event
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!V1beta1Event.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in V1beta1Event is not found in the empty JSON string", V1beta1Event.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!V1beta1Event.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `V1beta1Event` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : V1beta1Event.openapiRequiredFields) {
      ...
      if (jsonObj.get("series") != null && !jsonObj.get("series").isJsonNull()) {
        V1beta1EventSeries.validateJsonObject(jsonObj.getAsJsonObject("series"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!V1beta1Event.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'V1beta1Event' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<V1beta1Event> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(V1beta1Event.class));

       return (TypeAdapter<T>) new TypeAdapter<V1beta1Event>() {
           @Override
           public void write(JsonWriter out, V1beta1Event value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public V1beta1Event read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of V1beta1Event given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of V1beta1Event
  * @throws IOException if the JSON string is invalid with respect to V1beta1Event
  */
  public static V1beta1Event fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, V1beta1Event.class);
  }

 /**
  * Convert an instance of V1beta1Event to an JSON string
  *
  * @return JSON string
  */
