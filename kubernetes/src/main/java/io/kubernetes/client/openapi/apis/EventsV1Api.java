...
public class EventsV1Api {
     ...
     */
    public okhttp3.Call createNamespacedEventCall(String namespace, EventsV1Event body, String pretty, String dryRun, String fieldManager, String fieldValidation, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/apis/events.k8s.io/v1/namespaces/{namespace}/events"
    ...
    private okhttp3.Call createNamespacedEventValidateBeforeCall(String namespace, EventsV1Event body, String pretty, String dryRun, String fieldManager, String fieldValidation, final ApiCallback _callback) throws ApiException {
    ...
    public EventsV1Event createNamespacedEvent(String namespace, EventsV1Event body, String pretty, String dryRun, String fieldManager, String fieldValidation) throws ApiException {
        ApiResponse<EventsV1Event> localVarResp = createNamespacedEventWithHttpInfo(namespace, body, pretty, dryRun, fieldManager, fieldValidation);
     ...
     */
    public okhttp3.Call createNamespacedEventAsync(String namespace, EventsV1Event body, String pretty, String dryRun, String fieldManager, String fieldValidation, final ApiCallback<EventsV1Event> _callback) throws ApiException {
    ...
    public okhttp3.Call deleteNamespacedEventCall(String name, String namespace, String pretty, String dryRun, Integer gracePeriodSeconds, Boolean orphanDependents, String propagationPolicy, V1DeleteOptions body, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/apis/events.k8s.io/v1/namespaces/{namespace}/events/{name}"
    ...
    public EventsV1EventList listEventForAllNamespaces(Boolean allowWatchBookmarks, String _continue, String fieldSelector, String labelSelector, Integer limit, String pretty, String resourceVersion, String resourceVersionMatch, Integer timeoutSeconds, Boolean watch) throws ApiException {
        ApiResponse<EventsV1EventList> localVarResp = listEventForAllNamespacesWithHttpInfo(allowWatchBookmarks, _continue, fieldSelector, labelSelector, limit, pretty, resourceVersion, resourceVersionMatch, timeoutSeconds, watch);
        return localVarResp.getData();
    }
     ...
     */
    public okhttp3.Call listEventForAllNamespacesAsync(Boolean allowWatchBookmarks, String _continue, String fieldSelector, String labelSelector, Integer limit, String pretty, String resourceVersion, String resourceVersionMatch, Integer timeoutSeconds, Boolean watch, final ApiCallback<EventsV1EventList> _callback) throws ApiException {
    ...
    public EventsV1EventList listNamespacedEvent(String namespace, String pretty, Boolean allowWatchBookmarks, String _continue, String fieldSelector, String labelSelector, Integer limit, String resourceVersion, String resourceVersionMatch, Integer timeoutSeconds, Boolean watch) throws ApiException {
        ApiResponse<EventsV1EventList> localVarResp = listNamespacedEventWithHttpInfo(namespace, pretty, allowWatchBookmarks, _continue, fieldSelector, labelSelector, limit, resourceVersion, resourceVersionMatch, timeoutSeconds, watch);
        return localVarResp.getData();
    }
     ...
     */
    public okhttp3.Call listNamespacedEventAsync(String namespace, String pretty, Boolean allowWatchBookmarks, String _continue, String fieldSelector, String labelSelector, Integer limit, String resourceVersion, String resourceVersionMatch, Integer timeoutSeconds, Boolean watch, final ApiCallback<EventsV1EventList> _callback) throws ApiException {
    ...
    public EventsV1Event patchNamespacedEvent(String name, String namespace, V1Patch body, String pretty, String dryRun, String fieldManager, String fieldValidation, Boolean force) throws ApiException {
        ApiResponse<EventsV1Event> localVarResp = patchNamespacedEventWithHttpInfo(name, namespace, body, pretty, dryRun, fieldManager, fieldValidation, force);
        return localVarResp.getData();
    }
     ...
     */
    public okhttp3.Call patchNamespacedEventAsync(String name, String namespace, V1Patch body, String pretty, String dryRun, String fieldManager, String fieldValidation, Boolean force, final ApiCallback<EventsV1Event> _callback) throws ApiException {
    ...
    public EventsV1Event readNamespacedEvent(String name, String namespace, String pretty) throws ApiException {
        ApiResponse<EventsV1Event> localVarResp = readNamespacedEventWithHttpInfo(name, namespace, pretty);
        return localVarResp.getData();
    }
     ...
     */
    public okhttp3.Call readNamespacedEventAsync(String name, String namespace, String pretty, final ApiCallback<EventsV1Event> _callback) throws ApiException {
     ...
     */
    public okhttp3.Call replaceNamespacedEventCall(String name, String namespace, EventsV1Event body, String pretty, String dryRun, String fieldManager, String fieldValidation, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call replaceNamespacedEventValidateBeforeCall(String name, String namespace, EventsV1Event body, String pretty, String dryRun, String fieldManager, String fieldValidation, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'name' is set
        if (name == null) {
    ...
    public EventsV1Event replaceNamespacedEvent(String name, String namespace, EventsV1Event body, String pretty, String dryRun, String fieldManager, String fieldValidation) throws ApiException {
        ApiResponse<EventsV1Event> localVarResp = replaceNamespacedEventWithHttpInfo(name, namespace, body, pretty, dryRun, fieldManager, fieldValidation);
        return localVarResp.getData();
    }
     ...
     */
    public okhttp3.Call replaceNamespacedEventAsync(String name, String namespace, EventsV1Event body, String pretty, String dryRun, String fieldManager, String fieldValidation, final ApiCallback<EventsV1Event> _callback) throws ApiException {
