...
public class V1SelfSubjectAccessReview implements io.kubernetes.client.common.KubernetesObject {
  ...
  */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!V1SelfSubjectAccessReview.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'V1SelfSubjectAccessReview' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<V1SelfSubjectAccessReview> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(V1SelfSubjectAccessReview.class));

       return (TypeAdapter<T>) new TypeAdapter<V1SelfSubjectAccessReview>() {
           @Override
           public void write(JsonWriter out, V1SelfSubjectAccessReview value) throws IOException {
 ...
 /**
  * Create an instance of V1SelfSubjectAccessReview given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of V1SelfSubjectAccessReview
  * @throws IOException if the JSON string is invalid with respect to V1SelfSubjectAccessReview
  */
  public static V1SelfSubjectAccessReview fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, V1SelfSubjectAccessReview.class);
  }

 /**
  * Convert an instance of V1SelfSubjectAccessReview to an JSON string
  *
  * @return JSON string
  */
