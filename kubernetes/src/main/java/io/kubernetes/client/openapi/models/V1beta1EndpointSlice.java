...
public class V1beta1EndpointSlice implements io.kubernetes.client.common.KubernetesObject {
  ...
  private List<V1beta1EndpointPort> ports;
  ...
  * @throws IOException if the JSON Object is invalid with respect to V1beta1EndpointSlice
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!V1beta1EndpointSlice.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in V1beta1EndpointSlice is not found in the empty JSON string", V1beta1EndpointSlice.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!V1beta1EndpointSlice.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `V1beta1EndpointSlice` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : V1beta1EndpointSlice.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayendpoints.size(); i++) {
        V1beta1Endpoint.validateJsonObject(jsonArrayendpoints.get(i).getAsJsonObject());
      };
      ...
      if (jsonObj.get("ports") != null && !jsonObj.get("ports").isJsonNull()) {
        ...
        if (jsonArrayports != null) {
          ...
          for (int i = 0; i < jsonArrayports.size(); i++) {
            V1beta1EndpointPort.validateJsonObject(jsonArrayports.get(i).getAsJsonObject());
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!V1beta1EndpointSlice.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'V1beta1EndpointSlice' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<V1beta1EndpointSlice> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(V1beta1EndpointSlice.class));

       return (TypeAdapter<T>) new TypeAdapter<V1beta1EndpointSlice>() {
           @Override
           public void write(JsonWriter out, V1beta1EndpointSlice value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public V1beta1EndpointSlice read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of V1beta1EndpointSlice given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of V1beta1EndpointSlice
  * @throws IOException if the JSON string is invalid with respect to V1beta1EndpointSlice
  */
  public static V1beta1EndpointSlice fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, V1beta1EndpointSlice.class);
  }

 /**
  * Convert an instance of V1beta1EndpointSlice to an JSON string
  *
  * @return JSON string
  */
