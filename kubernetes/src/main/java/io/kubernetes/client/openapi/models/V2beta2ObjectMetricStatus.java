...
public class V2beta2ObjectMetricStatus {
  ...
  * @throws IOException if the JSON Object is invalid with respect to V2beta2ObjectMetricStatus
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!V2beta2ObjectMetricStatus.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in V2beta2ObjectMetricStatus is not found in the empty JSON string", V2beta2ObjectMetricStatus.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!V2beta2ObjectMetricStatus.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `V2beta2ObjectMetricStatus` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : V2beta2ObjectMetricStatus.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!V2beta2ObjectMetricStatus.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'V2beta2ObjectMetricStatus' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<V2beta2ObjectMetricStatus> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(V2beta2ObjectMetricStatus.class));

       return (TypeAdapter<T>) new TypeAdapter<V2beta2ObjectMetricStatus>() {
           @Override
           public void write(JsonWriter out, V2beta2ObjectMetricStatus value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public V2beta2ObjectMetricStatus read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of V2beta2ObjectMetricStatus given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of V2beta2ObjectMetricStatus
  * @throws IOException if the JSON string is invalid with respect to V2beta2ObjectMetricStatus
  */
  public static V2beta2ObjectMetricStatus fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, V2beta2ObjectMetricStatus.class);
  }

 /**
  * Convert an instance of V2beta2ObjectMetricStatus to an JSON string
  *
  * @return JSON string
  */
