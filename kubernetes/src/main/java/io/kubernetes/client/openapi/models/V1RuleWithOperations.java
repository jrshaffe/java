...
public class V1RuleWithOperations {
  ...
  * @throws IOException if the JSON Object is invalid with respect to V1RuleWithOperations
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!V1RuleWithOperations.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
