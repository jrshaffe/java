...
public class JSON {
...

    {
        ...
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V1Subject.CustomTypeAdapterFactory());
        ...
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V1alpha1CSIStorageCapacity.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V1alpha1CSIStorageCapacityList.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V1alpha1Overhead.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V1alpha1RuntimeClass.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V1alpha1RuntimeClassList.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V1alpha1RuntimeClassSpec.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V1alpha1Scheduling.CustomTypeAdapterFactory());
        ...
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V1beta1AllowedCSIDriver.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V1beta1AllowedFlexVolume.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V1beta1AllowedHostPath.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V1beta1CSIStorageCapacity.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V1beta1CSIStorageCapacityList.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V1beta1CronJob.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V1beta1CronJobList.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V1beta1CronJobSpec.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V1beta1CronJobStatus.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V1beta1Endpoint.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V1beta1EndpointConditions.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V1beta1EndpointHints.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V1beta1EndpointPort.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V1beta1EndpointSlice.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V1beta1EndpointSliceList.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V1beta1Event.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V1beta1EventList.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V1beta1EventSeries.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V1beta1FSGroupStrategyOptions.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V1beta1FlowDistinguisherMethod.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V1beta1FlowSchema.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V1beta1FlowSchemaCondition.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V1beta1FlowSchemaList.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V1beta1FlowSchemaSpec.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V1beta1FlowSchemaStatus.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V1beta1ForZone.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V1beta1GroupSubject.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V1beta1HostPortRange.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V1beta1IDRange.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V1beta1JobTemplateSpec.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V1beta1LimitResponse.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V1beta1LimitedPriorityLevelConfiguration.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V1beta1NonResourcePolicyRule.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V1beta1Overhead.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V1beta1PodDisruptionBudget.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V1beta1PodDisruptionBudgetList.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V1beta1PodDisruptionBudgetSpec.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V1beta1PodDisruptionBudgetStatus.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V1beta1PodSecurityPolicy.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V1beta1PodSecurityPolicyList.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V1beta1PodSecurityPolicySpec.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V1beta1PolicyRulesWithSubjects.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V1beta1PriorityLevelConfiguration.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V1beta1PriorityLevelConfigurationCondition.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V1beta1PriorityLevelConfigurationList.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V1beta1PriorityLevelConfigurationReference.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V1beta1PriorityLevelConfigurationSpec.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V1beta1PriorityLevelConfigurationStatus.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V1beta1QueuingConfiguration.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V1beta1ResourcePolicyRule.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V1beta1RunAsGroupStrategyOptions.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V1beta1RunAsUserStrategyOptions.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V1beta1RuntimeClass.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V1beta1RuntimeClassList.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V1beta1RuntimeClassStrategyOptions.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V1beta1SELinuxStrategyOptions.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V1beta1Scheduling.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V1beta1ServiceAccountSubject.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V1beta1Subject.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V1beta1SupplementalGroupsStrategyOptions.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V1beta1UserSubject.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V1beta2FlowDistinguisherMethod.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V1beta2FlowSchema.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V1beta2FlowSchemaCondition.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V1beta2FlowSchemaList.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V1beta2FlowSchemaSpec.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V1beta2FlowSchemaStatus.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V1beta2GroupSubject.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V1beta2LimitResponse.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V1beta2LimitedPriorityLevelConfiguration.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V1beta2NonResourcePolicyRule.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V1beta2PolicyRulesWithSubjects.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V1beta2PriorityLevelConfiguration.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V1beta2PriorityLevelConfigurationCondition.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V1beta2PriorityLevelConfigurationList.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V1beta2PriorityLevelConfigurationReference.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V1beta2PriorityLevelConfigurationSpec.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V1beta2PriorityLevelConfigurationStatus.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V1beta2QueuingConfiguration.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V1beta2ResourcePolicyRule.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V1beta2ServiceAccountSubject.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V1beta2Subject.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V1beta2UserSubject.CustomTypeAdapterFactory());
        ...
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V2beta1ContainerResourceMetricSource.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V2beta1ContainerResourceMetricStatus.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V2beta1CrossVersionObjectReference.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V2beta1ExternalMetricSource.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V2beta1ExternalMetricStatus.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V2beta1HorizontalPodAutoscaler.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V2beta1HorizontalPodAutoscalerCondition.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V2beta1HorizontalPodAutoscalerList.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V2beta1HorizontalPodAutoscalerSpec.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V2beta1HorizontalPodAutoscalerStatus.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V2beta1MetricSpec.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V2beta1MetricStatus.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V2beta1ObjectMetricSource.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V2beta1ObjectMetricStatus.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V2beta1PodsMetricSource.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V2beta1PodsMetricStatus.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V2beta1ResourceMetricSource.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V2beta1ResourceMetricStatus.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V2beta2ContainerResourceMetricSource.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V2beta2ContainerResourceMetricStatus.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V2beta2CrossVersionObjectReference.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V2beta2ExternalMetricSource.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V2beta2ExternalMetricStatus.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V2beta2HPAScalingPolicy.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V2beta2HPAScalingRules.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V2beta2HorizontalPodAutoscaler.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V2beta2HorizontalPodAutoscalerBehavior.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V2beta2HorizontalPodAutoscalerCondition.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V2beta2HorizontalPodAutoscalerList.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V2beta2HorizontalPodAutoscalerSpec.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V2beta2HorizontalPodAutoscalerStatus.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V2beta2MetricIdentifier.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V2beta2MetricSpec.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V2beta2MetricStatus.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V2beta2MetricTarget.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V2beta2MetricValueStatus.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V2beta2ObjectMetricSource.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V2beta2ObjectMetricStatus.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V2beta2PodsMetricSource.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V2beta2PodsMetricStatus.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V2beta2ResourceMetricSource.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new io.kubernetes.client.openapi.models.V2beta2ResourceMetricStatus.CustomTypeAdapterFactory());
