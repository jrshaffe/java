...
public class V1Binding implements io.kubernetes.client.common.KubernetesObject {
  ...
  */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!V1Binding.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'V1Binding' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<V1Binding> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(V1Binding.class));

       return (TypeAdapter<T>) new TypeAdapter<V1Binding>() {
           @Override
           public void write(JsonWriter out, V1Binding value) throws IOException {
 ...
 /**
  * Create an instance of V1Binding given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of V1Binding
  * @throws IOException if the JSON string is invalid with respect to V1Binding
  */
  public static V1Binding fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, V1Binding.class);
  }

 /**
  * Convert an instance of V1Binding to an JSON string
  *
  * @return JSON string
  */
