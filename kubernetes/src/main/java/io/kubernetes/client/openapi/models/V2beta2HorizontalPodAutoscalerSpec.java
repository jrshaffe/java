...
public class V2beta2HorizontalPodAutoscalerSpec {
  ...
  private List<V2beta2MetricSpec> metrics;
  ...
  * @throws IOException if the JSON Object is invalid with respect to V2beta2HorizontalPodAutoscalerSpec
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!V2beta2HorizontalPodAutoscalerSpec.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in V2beta2HorizontalPodAutoscalerSpec is not found in the empty JSON string", V2beta2HorizontalPodAutoscalerSpec.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!V2beta2HorizontalPodAutoscalerSpec.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `V2beta2HorizontalPodAutoscalerSpec` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : V2beta2HorizontalPodAutoscalerSpec.openapiRequiredFields) {
      ...
      if (jsonObj.get("behavior") != null && !jsonObj.get("behavior").isJsonNull()) {
        V2beta2HorizontalPodAutoscalerBehavior.validateJsonObject(jsonObj.getAsJsonObject("behavior"));
      }
      if (jsonObj.get("metrics") != null && !jsonObj.get("metrics").isJsonNull()) {
        ...
        if (jsonArraymetrics != null) {
          ...
          for (int i = 0; i < jsonArraymetrics.size(); i++) {
            V2beta2MetricSpec.validateJsonObject(jsonArraymetrics.get(i).getAsJsonObject());
          };
        }
      }
      // validate the required field `scaleTargetRef`
      V2beta2CrossVersionObjectReference.validateJsonObject(jsonObj.getAsJsonObject("scaleTargetRef"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!V2beta2HorizontalPodAutoscalerSpec.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'V2beta2HorizontalPodAutoscalerSpec' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<V2beta2HorizontalPodAutoscalerSpec> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(V2beta2HorizontalPodAutoscalerSpec.class));

       return (TypeAdapter<T>) new TypeAdapter<V2beta2HorizontalPodAutoscalerSpec>() {
           @Override
           public void write(JsonWriter out, V2beta2HorizontalPodAutoscalerSpec value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public V2beta2HorizontalPodAutoscalerSpec read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of V2beta2HorizontalPodAutoscalerSpec given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of V2beta2HorizontalPodAutoscalerSpec
  * @throws IOException if the JSON string is invalid with respect to V2beta2HorizontalPodAutoscalerSpec
  */
  public static V2beta2HorizontalPodAutoscalerSpec fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, V2beta2HorizontalPodAutoscalerSpec.class);
  }

 /**
  * Convert an instance of V2beta2HorizontalPodAutoscalerSpec to an JSON string
  *
  * @return JSON string
  */
