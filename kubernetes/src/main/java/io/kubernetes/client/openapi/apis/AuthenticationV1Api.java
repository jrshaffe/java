...
public class AuthenticationV1Api {
     ...
     */
    public okhttp3.Call createTokenReviewCall(V1TokenReview body, String dryRun, String fieldManager, String fieldValidation, String pretty, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call createTokenReviewValidateBeforeCall(V1TokenReview body, String dryRun, String fieldManager, String fieldValidation, String pretty, final ApiCallback _callback) throws ApiException {
     ...
     */
    public okhttp3.Call createTokenReviewAsync(V1TokenReview body, String dryRun, String fieldManager, String fieldValidation, String pretty, final ApiCallback<V1TokenReview> _callback) throws ApiException {
