...
import io.kubernetes.client.openapi.models.V1beta1FlowDistinguisherMethod;
import io.kubernetes.client.openapi.models.V1beta1PolicyRulesWithSubjects;
import io.kubernetes.client.openapi.models.V1beta1PriorityLevelConfigurationReference;
...
public class V1beta1FlowSchemaSpec {
  ...
  private List<V1beta1PolicyRulesWithSubjects> rules;
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.distinguisherMethod, v1beta1FlowSchemaSpec.distinguisherMethod) &&
        ...
        Objects.equals(this.priorityLevelConfiguration, v1beta1FlowSchemaSpec.priorityLevelConfiguration) &&
  ...
  * @throws IOException if the JSON Object is invalid with respect to V1beta1FlowSchemaSpec
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!V1beta1FlowSchemaSpec.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in V1beta1FlowSchemaSpec is not found in the empty JSON string", V1beta1FlowSchemaSpec.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!V1beta1FlowSchemaSpec.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `V1beta1FlowSchemaSpec` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : V1beta1FlowSchemaSpec.openapiRequiredFields) {
      ...
      if (jsonObj.get("distinguisherMethod") != null && !jsonObj.get("distinguisherMethod").isJsonNull()) {
        V1beta1FlowDistinguisherMethod.validateJsonObject(jsonObj.getAsJsonObject("distinguisherMethod"));
      }
      // validate the required field `priorityLevelConfiguration`
      V1beta1PriorityLevelConfigurationReference.validateJsonObject(jsonObj.getAsJsonObject("priorityLevelConfiguration"));
      if (jsonObj.get("rules") != null && !jsonObj.get("rules").isJsonNull()) {
        ...
        if (jsonArrayrules != null) {
          ...
          for (int i = 0; i < jsonArrayrules.size(); i++) {
            V1beta1PolicyRulesWithSubjects.validateJsonObject(jsonArrayrules.get(i).getAsJsonObject());
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!V1beta1FlowSchemaSpec.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'V1beta1FlowSchemaSpec' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<V1beta1FlowSchemaSpec> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(V1beta1FlowSchemaSpec.class));

       return (TypeAdapter<T>) new TypeAdapter<V1beta1FlowSchemaSpec>() {
           @Override
           public void write(JsonWriter out, V1beta1FlowSchemaSpec value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public V1beta1FlowSchemaSpec read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of V1beta1FlowSchemaSpec given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of V1beta1FlowSchemaSpec
  * @throws IOException if the JSON string is invalid with respect to V1beta1FlowSchemaSpec
  */
  public static V1beta1FlowSchemaSpec fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, V1beta1FlowSchemaSpec.class);
  }

 /**
  * Convert an instance of V1beta1FlowSchemaSpec to an JSON string
  *
  * @return JSON string
  */
