...
public class V1beta1NonResourcePolicyRule {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.nonResourceURLs, v1beta1NonResourcePolicyRule.nonResourceURLs) &&
        Objects.equals(this.verbs, v1beta1NonResourcePolicyRule.verbs);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to V1beta1NonResourcePolicyRule
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!V1beta1NonResourcePolicyRule.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in V1beta1NonResourcePolicyRule is not found in the empty JSON string", V1beta1NonResourcePolicyRule.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!V1beta1NonResourcePolicyRule.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `V1beta1NonResourcePolicyRule` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : V1beta1NonResourcePolicyRule.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!V1beta1NonResourcePolicyRule.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'V1beta1NonResourcePolicyRule' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<V1beta1NonResourcePolicyRule> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(V1beta1NonResourcePolicyRule.class));

       return (TypeAdapter<T>) new TypeAdapter<V1beta1NonResourcePolicyRule>() {
           @Override
           public void write(JsonWriter out, V1beta1NonResourcePolicyRule value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public V1beta1NonResourcePolicyRule read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of V1beta1NonResourcePolicyRule given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of V1beta1NonResourcePolicyRule
  * @throws IOException if the JSON string is invalid with respect to V1beta1NonResourcePolicyRule
  */
  public static V1beta1NonResourcePolicyRule fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, V1beta1NonResourcePolicyRule.class);
  }

 /**
  * Convert an instance of V1beta1NonResourcePolicyRule to an JSON string
  *
  * @return JSON string
  */
