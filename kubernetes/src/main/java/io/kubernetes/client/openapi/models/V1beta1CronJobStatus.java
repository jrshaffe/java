...
public class V1beta1CronJobStatus {
  ...
  * @throws IOException if the JSON Object is invalid with respect to V1beta1CronJobStatus
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!V1beta1CronJobStatus.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in V1beta1CronJobStatus is not found in the empty JSON string", V1beta1CronJobStatus.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!V1beta1CronJobStatus.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `V1beta1CronJobStatus` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!V1beta1CronJobStatus.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'V1beta1CronJobStatus' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<V1beta1CronJobStatus> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(V1beta1CronJobStatus.class));

       return (TypeAdapter<T>) new TypeAdapter<V1beta1CronJobStatus>() {
           @Override
           public void write(JsonWriter out, V1beta1CronJobStatus value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public V1beta1CronJobStatus read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of V1beta1CronJobStatus given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of V1beta1CronJobStatus
  * @throws IOException if the JSON string is invalid with respect to V1beta1CronJobStatus
  */
  public static V1beta1CronJobStatus fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, V1beta1CronJobStatus.class);
  }

 /**
  * Convert an instance of V1beta1CronJobStatus to an JSON string
  *
  * @return JSON string
  */
