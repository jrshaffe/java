...
public class V1beta1PolicyRulesWithSubjects {
  ...
  * @throws IOException if the JSON Object is invalid with respect to V1beta1PolicyRulesWithSubjects
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!V1beta1PolicyRulesWithSubjects.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in V1beta1PolicyRulesWithSubjects is not found in the empty JSON string", V1beta1PolicyRulesWithSubjects.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!V1beta1PolicyRulesWithSubjects.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `V1beta1PolicyRulesWithSubjects` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : V1beta1PolicyRulesWithSubjects.openapiRequiredFields) {
      ...
      if (jsonObj.get("nonResourceRules") != null && !jsonObj.get("nonResourceRules").isJsonNull()) {
        ...
        if (jsonArraynonResourceRules != null) {
          ...
          for (int i = 0; i < jsonArraynonResourceRules.size(); i++) {
            V1beta1NonResourcePolicyRule.validateJsonObject(jsonArraynonResourceRules.get(i).getAsJsonObject());
          };
        }
      }
      if (jsonObj.get("resourceRules") != null && !jsonObj.get("resourceRules").isJsonNull()) {
        ...
        if (jsonArrayresourceRules != null) {
          ...
          for (int i = 0; i < jsonArrayresourceRules.size(); i++) {
            V1beta1ResourcePolicyRule.validateJsonObject(jsonArrayresourceRules.get(i).getAsJsonObject());
          };
        }
      }
      // ensure the json data is an array
      ...
      for (int i = 0; i < jsonArraysubjects.size(); i++) {
        V1beta1Subject.validateJsonObject(jsonArraysubjects.get(i).getAsJsonObject());
      };
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!V1beta1PolicyRulesWithSubjects.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'V1beta1PolicyRulesWithSubjects' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<V1beta1PolicyRulesWithSubjects> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(V1beta1PolicyRulesWithSubjects.class));

       return (TypeAdapter<T>) new TypeAdapter<V1beta1PolicyRulesWithSubjects>() {
           @Override
           public void write(JsonWriter out, V1beta1PolicyRulesWithSubjects value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public V1beta1PolicyRulesWithSubjects read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of V1beta1PolicyRulesWithSubjects given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of V1beta1PolicyRulesWithSubjects
  * @throws IOException if the JSON string is invalid with respect to V1beta1PolicyRulesWithSubjects
  */
  public static V1beta1PolicyRulesWithSubjects fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, V1beta1PolicyRulesWithSubjects.class);
  }

 /**
  * Convert an instance of V1beta1PolicyRulesWithSubjects to an JSON string
  *
  * @return JSON string
  */
