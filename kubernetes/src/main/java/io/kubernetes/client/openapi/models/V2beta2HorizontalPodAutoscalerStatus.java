...
public class V2beta2HorizontalPodAutoscalerStatus {
  ...
  * @throws IOException if the JSON Object is invalid with respect to V2beta2HorizontalPodAutoscalerStatus
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!V2beta2HorizontalPodAutoscalerStatus.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in V2beta2HorizontalPodAutoscalerStatus is not found in the empty JSON string", V2beta2HorizontalPodAutoscalerStatus.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!V2beta2HorizontalPodAutoscalerStatus.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `V2beta2HorizontalPodAutoscalerStatus` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : V2beta2HorizontalPodAutoscalerStatus.openapiRequiredFields) {
      ...
      if (jsonObj.get("conditions") != null && !jsonObj.get("conditions").isJsonNull()) {
        ...
        if (jsonArrayconditions != null) {
          ...
          for (int i = 0; i < jsonArrayconditions.size(); i++) {
            V2beta2HorizontalPodAutoscalerCondition.validateJsonObject(jsonArrayconditions.get(i).getAsJsonObject());
          };
        }
      }
      if (jsonObj.get("currentMetrics") != null && !jsonObj.get("currentMetrics").isJsonNull()) {
        ...
        if (jsonArraycurrentMetrics != null) {
          ...
          for (int i = 0; i < jsonArraycurrentMetrics.size(); i++) {
            V2beta2MetricStatus.validateJsonObject(jsonArraycurrentMetrics.get(i).getAsJsonObject());
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!V2beta2HorizontalPodAutoscalerStatus.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'V2beta2HorizontalPodAutoscalerStatus' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<V2beta2HorizontalPodAutoscalerStatus> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(V2beta2HorizontalPodAutoscalerStatus.class));

       return (TypeAdapter<T>) new TypeAdapter<V2beta2HorizontalPodAutoscalerStatus>() {
           @Override
           public void write(JsonWriter out, V2beta2HorizontalPodAutoscalerStatus value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public V2beta2HorizontalPodAutoscalerStatus read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of V2beta2HorizontalPodAutoscalerStatus given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of V2beta2HorizontalPodAutoscalerStatus
  * @throws IOException if the JSON string is invalid with respect to V2beta2HorizontalPodAutoscalerStatus
  */
  public static V2beta2HorizontalPodAutoscalerStatus fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, V2beta2HorizontalPodAutoscalerStatus.class);
  }

 /**
  * Convert an instance of V2beta2HorizontalPodAutoscalerStatus to an JSON string
  *
  * @return JSON string
  */
